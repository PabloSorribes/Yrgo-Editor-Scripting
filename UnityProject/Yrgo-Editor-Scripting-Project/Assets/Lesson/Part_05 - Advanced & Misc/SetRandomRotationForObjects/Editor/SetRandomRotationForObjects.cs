...
public class SetRandomRotationForObjects : EditorWindow
{
	//#u translates to "shift + r" which has been the keyboard shortcut bound to this window
	//It can otherwise be found under "YRGO/Part 05/SetRandomRotationForObjects" in the regular row of menus
	...
	{
		var window = GetWindow<SetRandomRotationForObjects>();
	...
	private void OnGUI()
	{
		...
		//Start Testing stupid layout stuff
		...
		//End Testing stupid layout stuff
